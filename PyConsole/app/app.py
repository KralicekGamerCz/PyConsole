...
def cmd():
    application = input(__main__.barva_1 + __main__.username + __main__.barva_2 + "@" + __main__.barva_3 + "local" + colors.yellow + "[app]" + colors.reset + "$ ")
    ...
    elif application == "kámennůžkypapír":
        def app_knp():
