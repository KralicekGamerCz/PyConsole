...
# welcome message
def welcome():
    print("PyConsole [Version PreRelese 1.4] \n©2023 by KralicekGamer\n")
...
# core(commands)
def core():
    command = input(user_name + "@local$ ")

    if command == "tisk":
        tisk = input(user_name + "@local-[tisk]$ ")
        print(tisk)
        core()
...
VYMAZAT-vymaže
    ...
    if command == "app":
        ...
        application = input(user_name + "@local-[app]$ ")
...
# run
welcome()
user_name = input("Zde zadej uživatelské jméno: ")
core()
